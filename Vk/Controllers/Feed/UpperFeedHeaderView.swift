...
class UpperFeedHeaderView:UITableViewHeaderFooterView  {
    ...
    private var avatarArray: [UIImage]  = [] {didSet {
        self.storiesCollection.reloadData()
    }}

    private lazy var newsButtom = UIElementFactory().addTextButtom(lable: "newsButtomFeed".localized,
                                                                   size: 14,
    ...
    private let forYouButtom = UIElementFactory().addTextButtom(lable: "forYouButtom".localized,
                                                                size: 14,
                                                                titleColor: .textColor,
                                                                contentHorizontalAlignment: .center) {
        print("forYouButtom")
    ...
    func setStories (addAvatar: UIImage) {
        self.avatarArray.append(addAvatar)
    }
...
extension UpperFeedHeaderView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageView.image = avatarArray[indexPath.item]
        return cell
    }
}
